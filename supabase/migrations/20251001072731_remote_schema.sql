...
create domain interview_round as integer check(value between 1 and 5);
...
create domain percent as integer check(value between 1 and 100);
create domain role_level as integer check(value between 0 and 4);
