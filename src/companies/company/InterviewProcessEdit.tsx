...
const InterviewProcessEdit = ({
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-[8%_91%] gap-2">
          ...
          <div className="col-start-2 col-span-4 text-sm">
            <div className="flex flex-col">
              ...
              <div>
                2. Type "Take Home" requires Location "Offline" and Duration
                Unit "Days"
              </div>
              <div>
      ...
      <Hr />
      <div className="grid grid-cols-[15%_15%]">
        <NumberInput
          id="pipeline_size"
          label="Pipeline size"
          value={interviewProcess.pipeline_size}
          min={1}
          max={10}
          onChange={(pipeline_size) =>
            setInterviewProcess((process) => {
              if (!pipeline_size) {
                return process;
              }
      ...
      <div className="mt-4 text-sm w-[85%] text-justify">
        ...
        (either by the job seeker or the company).
      </div>
    </>
  );
};
