...
//             FILTERS_HEIGHT_PX = 52 + 1; // 1px for border
//      FILTERS_MARGIN_BOTTOM_PX = 4 * 4;
//       FILTERS_TOTAL_HEIGHT_PX = 69; // FILTERS_HEIGHT_PX + FILTERS_MARGIN_BOTTOM_PX;
...
const ResourcesContainer = ({
  ...
  const height = (() => {
    switch (bannerType) {
      ...
      case 'filters':
        return 'h-[calc(100dvh-165px)]'; // HEADER_TOTAL_HEIGHT_PX + PAGE_MARGIN_BOTTOM_PX + FILTERS_TOTAL_HEIGHT_PX = 80 + 16 + 69
      case 'status':
